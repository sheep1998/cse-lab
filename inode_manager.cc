...
block_manager::alloc_block()
{
   ...
   */
	...
	pthread_mutex_lock(&bitmap_mutex); // lock
...
block_manager::block_manager()
{
  ...
  sb.ninodes = INODE_NUM;
	...
	//let reserved block not available
	...
	write_block(1, buf); //write super block

	pthread_mutex_init(&bitmap_mutex, NULL); // init bitmap lock
}
...
inode_manager::inode_manager()
{
  ...
  pthread_mutex_init(&inode_mutex, NULL); //init inode lock
}
